...
However, laboratory-based studies of animal locomotion are necessarily limited in scope, and as yet, relatively fewer studies have attempted 3D tracking in natural settings \citep{Munk, Clark, Theriault, Shelton, Sholtis, citations}.
...
\dennis{Someone added in the names of the software routines; I'd just as soon leave them out here and add a table instead and detail their use in methods? It gets a bit clunky
to list the names, dependencies, etc...}
...
\begin{figure}
\caption{(a) Example video frame showing acquisition of GoPro Hero3 Black camera lens intrinsics from a dot grid.  (b) Pattern detected using the \detectpatterns\ Python script. \dennis{What does this one want to show? Good practice for filming board shots}}
\label{fig:labcal1}
% PLACEHOLDER ONLY
\includegraphics[width=3in]{figures/labcal1A.png}
\includegraphics[width=3in]{figures/labcal1B.png}
\end{figure}
...
% PLACEHOLDER ONLY
A
B \includegraphics[width=3in]{figures/labex1B.png}
C \includegraphics[width=3in]{figures/labex1C.png}
D \includegraphics[width=3in]{figures/labex1D.png}
\end{figure}
...
\begin{figure}
\includegraphics[width=6in]{figures/beeFig.jpg}
...
%Pranav notes that the things can overheat.  Provide shade.  Provide ice. 
...
We thank Dylan Ray, Jorge Blat-Martinez, Katherine Sholtis, Amanda Lohmann, Jen Heyward, Shanim Patel, Pranav Khandelwal, Jonathan Rader; (Brandon's people); (folks who have contacted us asking for help on easyWand5 and setups and their own calibrations). The work is supported by ONR MURI Blahblah and NSF IOS Blahblah to TH. 
