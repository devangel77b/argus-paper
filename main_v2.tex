...
However, laboratory-based studies of animal locomotion are necessarily limited in scope, and as yet, relatively fewer studies have attempted 3D tracking in natural settings \citep{Munk:2015, Clark:2009, Theriault:2014, Shelton14, sholtis2015, citations}.
...
\label{fig:audiosync}
\begin{center}
\includegraphics{figures/sound/sound.pdf}
\end{center}
\end{figure}
...
\dennis{The software routines also include a basic capability to undistort using an omnidirectional camera model \citep{Scaramuzza:2006, urban2015improved} rather than a pinhole model with radial and tangential distortion coefficients.  These are especially useful for very high distortion fisheye lenses and wide shooting modes, such as GoPro Hero4 Black 2.7k and 1440 wide modes.  In these cases, we recommend undistorting the raw videos before digitization and analysis with other tools that employ pinhole camera models with radial and tangential distortion coefficients.}
...
D \includegraphics[width=3in]{figures/labex1/panel1d.pdf}
E \includegraphics[width=3in]{figures/labex1/panel1e.pdf}
...
\subsection*{Extreme distortion in fisheye and catadioptric lenses}
\dennis{Or does this go here? The software routines also include a basic capability to undistort using omnidirectional cameras \citep{Scaramuzza:2006, urban2015improved}.  These are especially useful for very high distortion fisheye lenses and wide shooting modes, such as GoPro Hero4 Black 2.7k and 1440 wide modes.  In these cases, we recommend undistorting the raw videos before prior to digitization and analysis with other tools that employ pinhole camera models with radial and tangential distortion coefficients.}
...
We thank Jorge Blat-Martinez, Katherine Sholtis, Amanda Lohmann, Jen Heyward, Shanim Patel, Pranav Khandelwal, Jonathan Rader; (Brandon's people); (folks who have contacted us asking for help on easyWand5 and setups and their own calibrations). The work is supported by the Office of Naval Research (\#N0001410109452 to T.H. and $n$ others) and by the National Science Foundation (IOS 1253276 to T.H.).
